...
export const ButtonCta = ({ text, iconLeft, variant, outline, type }: ButtonProps) => {
  return (
    <button
      type={type}
      draggable={false}
    ...
    >
      <div className="flex items-center justify-center gap-2">
        ...
        <div className="flex justify-end items-center gap-3">
          <div className=" text-xs md:text-sm pt-0.5 font-neue font-medium leading-none uppercase group-hover:translate-x-5 transition-transform ease-out duration-300">{text}</div>
